...
# 定义根文件目录
root_dir = "model/gan_model_step_1"
root_dir_2 = "model/gan_model_step_2"
...
def gan_step_1(gain_parameters, args):
    ...
    torch.save(generator.state_dict(), f'{root_dir}/generator.pth')
    torch.save(discriminator.state_dict(), f'{root_dir}/discriminator.pth')

    # Save optimizers
    torch.save(G_optimizer.state_dict(), f'{root_dir}/G_optimizer.pth')
    torch.save(D_optimizer.state_dict(), f'{root_dir}/D_optimizer.pth')

    # Save models after training
    torch.save(generator.state_dict(), f'{root_dir_2}/generator_5000.pth')
    torch.save(discriminator.state_dict(), f'{root_dir_2}/discriminator_5000.pth')

    # Save optimizers
    torch.save(G_optimizer.state_dict(), f'{root_dir_2}/G_optimizer_5000.pth')
    torch.save(D_optimizer.state_dict(), f'{root_dir_2}/D_optimizer_5000.pth')
